...
public class OrderController {
    ...
    public ResponseEntity updateOrder(@PathVariable long id, @RequestBody @Valid Order order) {
    ...
    public ResponseEntity getOrdersByOrderStatus(@PathVariable String orderStatus) {
        List<Order> orders = orderService.getOrdersByOrderStatus(Order.OrderStatus.valueOf(orderStatus.toUpperCase()));
        return ResponseEntity.ok(orders);
    }
