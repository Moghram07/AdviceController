...
public class RatingController {
    ...
    public ResponseEntity updateRating(@PathVariable long id, @RequestBody @Valid Rating rating) {
    ...
    public ResponseEntity rateProduct(@PathVariable Long productId, @RequestBody @Valid Rating rating) {
